...
$para1 = array(
    ...
    <h3>Joseph Perrier cellars, Châlons-en-Champagne</h3>"
);

$para2 = array(
    "<p>
    &nbsp &nbsp &nbsp Nous voici au cœur d’une cave de 3km de long datant du IVe siècle, 
    creusée dans d'anciennes crayères gallo-romaines. Depuis 1825, année de création de la Maison 
...
$para3 = array(
    "<p>Les galeries sont percées par des trous laissant entrer des puits de lumière qu’on appelle essors. Ces essors permettaient avant tout de diriger la lumière pour le travail des ouvriers mais servent également de ventilation.
    En 2018, la maison décide de rénover ses caves afin de faciliter et rendre la visite de ses caves plus agréables et missionne le concepteur de lumière <a href='http://www.lumesens.com/'>Emeric Thiénot</a> sur l’éclairage de ses caves.
    Afin d’éviter le “Goût Lumière” un défaut créé par une réaction chimique de la lumière sur le vin, Emeric Thiénot s’adapte à une contrainte d’un niveau très faible d’éclairement de 595nm et d’une couleur orangée rentrant en direct avec le vin le mettant en avant de la meilleur des façons. 
    Ainsi, ces caves abritent des millions de bouteilles de champagne vieillissant de 3 à 5 ans.
    </p>
    <h3>Caves de Champagne Moët et Chandon</h3>",
...
$para5 = array(
    "<p>Ces galeries interminables se coupent entre elles, créant un réel labyrinthe souterrain. 
    En marchant dans la pénombre de ces galeries , on peut observer les traces des outils qui ont taillé cette craie avec une faible lueur de lumière éclairant à peine les bouteilles  afin qu’elles gardent leur goût authentique.
    </p>
...
$para7 = array(
    "<p>Elaboré à partir d’un mariage de plusieurs crus provenant des grands terroirs de Champagne, le Cordon Rouge Mumm est composé en grande partie du Pinot Noir (45%) qui apporte structure et puissance, tandis que le Chardonnay (30%) apporte de la finesse et de l’élégance, enfin, Pinot Meunier son fruité et sa rondeur.
    Ainsi la cuvée cordon rouge est un champagne qui allie fruité et fraîcheur, parfait pour un apéritif. 
    La cuvée Mumm Grand Cordon quant à elle, fait honneur aux pinots noirs, issus des meilleurs crus. Ils s’accordent à la finesse et à l’élégance des chardonnays et à la rondeur fruitée des pinots meuniers.
    </p>

    <h3>Caves de Champagne Veuve Clicquot</h3>
...
$para8 = array(
    ...
    "<p>In this labyrinth located twenty meters underground, the temperature of the chalk pits, their constant hygrometry, as well as the calm that reigns there, make it the ideal place to host the production of champagne.
    Thus we find the emblematic cuvée \"Le brut Carte Jaune\" reflecting the vineyard of the House and the terroir of Champagne but also the cuvée in honor of Madame Cliquot \"La Grande dame\".
    </p>
    "
);

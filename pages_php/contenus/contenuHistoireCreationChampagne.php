...
$titre = array(
    "<h2>L'histoire de la création du vin de Champagne</h2>",
    "<h2>The history of the creation of Champagne wine</h2>"
);
...
$para2 = array(
    " <p>Pour créer le Champagne, il faut tout d'abord presser manuellement le raisin afin de faire éclater les baies. Une fois pressé, le jus de raisin doit être mis en cuve pendant 15 jours à une température de 18 à 20°C. Cette phase de fermentation permet de transformer les sucres du jus de raisin en un mélange d'alcool et de gaz carbonique qui permet de faire les bulles une fois dans le verre. Après les 15 jours, une phase de clarification est effectuée qui consiste à rendre le Champagne limpide en supprimant les particules solides qui altèrent sa saveur. Le résultat est mélangé avec des vins « tranquilles » (non effervescents) provenant d'autre récolte pour donner une saveur finale constante. 
    </p>",

    " <p>To create Champagne, the grapes must first be pressed by hand in order to burst the berries. Once pressed, the grape juice must be put in vats for 15 days at a temperature of 18 to 20°C. This fermentation phase allows the transformation of the sugars in the grape juice into a mixture of alcohol and carbon dioxide which allows the bubbles to be made once in the glass. After 15 days, a clarification phase is carried out which consists in making the Champagne clear by removing the solid particles which alter its taste. The result is blended with \"still\" wines (not sparkling) from other harvests to give a constant final flavor. 
    </p>"
);
...
$para3 = array(
    ...
    "<p>
    The result will have to be added sugar and yeast for a second fermentation that will transform the wine into an \"effervescent\" wine. The second fermentation can vary, from 15 months for the brut champagnes to 36 months to obtain a vintage. Once in the bottle, a stirring, manual or mechanical, is done to facilitate the accumulation of organic deposits, it consists in turning the bottle from left to right and then put the head down. The bottles will be frozen and then evacuated naturally during the disgorging process carried out by the neck of the bottle in a liquid at a temperature of -25°C. Finally the bottle is then ready to receive a cork to finalize the bottle.
    </p>
    <p>
